...
public class WebServer implements Runnable {
    ...
    /*
     * Lit les en-tetes de la requete
    ...
    /*
     * Methode appele si la requete n'est pas pour du CSS, JS, ...
     * donc pour renvoyer la page web
     * 'root' est le chemin du dossier (peut etre null)
     * */
     ...
     * si data est null alors file sera utilise, sinon data sera toujours prioritaire
     * ne doit pas etre utilise pour renvoyer de gros donnees (mp3, mp4, ...)
     * */
    ...
    /*
     * lit le fichier a renvoyer au client (le fichier cree puis efface apres utilisation)
     * ne doit pas etre utilise pour lire les donnees de gros fichier
     * */
    ...
    /*
     * Lit les donnees a partir d'un InputStream (en utilisant surtout Class.getResourceAsStream())
     * specialement pour renvoye les fichiers qui sont utilies a la page (CSS, JS, ...)
     * */
